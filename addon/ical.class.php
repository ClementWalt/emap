...
class iCal_Event
{
	...
	public function duration()
	{
		if ($this->_timeEnd) {
			...
			$d = ($this->_timeEnd - $this->_timeStart) / 3600;
	...
	public function Location(){
		...
		if(preg_match('/U[0-9]+/', $this->location, $m)){
	...
	public function Prof(){
		...
		if(preg_match("/[t]+[]].([A-Za-z]+[ ]+[A-Za-z]+)/",$this->description,$m)){
